...
By definition, a rational function is the quotient of two polynomials; and by @thm:rational-meromorphic-functions, in equivalent formulation, it is a function meromorphic on all of $extcomplex$. The poles and zeros may not accumulate in $extcomplex$, and thus there are finitely many as a consequence of Bolzano--Weierstrass (@thm:bolzano-weierstrass).
