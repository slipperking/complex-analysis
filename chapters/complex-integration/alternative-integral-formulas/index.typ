...
Let $Phi:DD -> RR$ be harmonic such that $Phi$ is continuous on $overline(DD)$. By the global mean-value property introduced in @lem:holomorphic-mean-value-property, we have
