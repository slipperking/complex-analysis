...
#show: docs-subchapter.with(
  ...
  route: "unit-disk-holomorphic-automorphisms",
)
...
#lbl(
  ...
  <thm:holomorphic-automorphism-group-on-unit-disk>,
)
...
As a direct consequence of @thm:holomorphic-automorphism-group-on-unit-disk, we have the following result:
