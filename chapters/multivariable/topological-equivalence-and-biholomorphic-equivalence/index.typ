...
#show: docs-subchapter.with(
  ...
  route: "topological-equivalence-and-biholomorphic-equivalence",
)
#lbl(
  lemma[
...
#proof[
  ...
  $
  where $bold(P)$ is a permutation matrix and $(theta_1, dots, theta_n) in [0, 2 uppi)^n$. Hence $Aut'(DD^n)$ is isomorphic to the group of unitary monomial matrices. The structure of $Aut'(B^n)$ is given by @prop:unit-ball-automorphism-fixed-point-at-zero, and each element corresponds uniquely to a unitary matrix. Thus there is a natural isomorphism $Aut'(B^n) tilde.equiv upright("U")(n)$, the $n times n$ _unitary group_.
