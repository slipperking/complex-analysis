...
#show: docs-subchapter.with(
  ...
  route: "ball-polydisk-holomorphic-automorphisms",
)
...
#proof[
  ...
  #lbl(
    ...
    $,
    <eq:multivariable-cartan-1-taylor-series>,
  )
  ...
  Trivially, $bold(a)_(1, 0, dots, 0) = pdv(bold(f), z_1)(bold(a)) = (1, 0, dots, 0)$ by @eq:multivariable-cartan-1-jacobian. Similarly, $bold(a)_(0, 1, 0, dots, 0) = (0, 1, 0, dots, 0), dots, bold(a)_(0, dots, 0, 1) = (0, dots, 0, 1)$. Hence, the linear homogeneous polynomial of @eq:multivariable-cartan-1-taylor-series equals
  $
  ...
  $
  is a nonzero constant by @prop:homogeneous-polynomial-derivatives. Consequently,
  $
...
#proof[
  ...
  $
  By @lem:multivariable-cartan-1, $bold(phi)(bold(z)) equiv bold(z)$ on $Omega$. Hence, $bold(f) compose bold(rho)_theta = bold(rho)_theta compose bold(f)$ for all $theta in RR$. Together with @thm:taylor-expansion-multivariable, write
  #lbl(
    $
...
#lbl(
  theorem[The Holomorphic Automorphism Group on $DD^n$][
    ...
    #lbl(
      ...
      $,
      <eq:holomorphic-automorphism-group-on-polydisk-statement>,
    )
  ...
  <thm:holomorphic-automorphism-group-on-polydisk>,
)
...
#proof[
  ...
  #lbl(
    ...
    $,
    <eq:holomorphic-automorphism-group-on-polydisk-absolute-sum-estimate>,
  )
  ...
  $
  as in @eq:holomorphic-automorphism-group-on-polydisk-statement. Finally, each automorphism of this form lies in $Aut(DD^n)$ trivially.
]
...
#lbl(
  ...
  <prop:unit-ball-automorphism-fixed-point-at-zero>,
)
...
#proof[
  ...
  #lbl(
    ...
    $,
    <eq:unit-ball-automorphism-fixed-point-at-zero_diagonalentries>,
  )
  ...
  $
  which implies that $sum_(k=1)^n Im(zeta_(k,i) overline(zeta_(k,j))) = 0$. Therefore, by @eq:unit-ball-automorphism-fixed-point-at-zero_diagonalentries, for all $i, j in {1, dots, n}$, observe that
  $
...
#lbl(
  ...
  <prop:group-divisibility-preserved-under-isomorphisms>,
)
...
#lbl(
  theorem[The Holomorphic Automorphism Group on $B^n$][
    ...
    #lbl(
      ...
      $,
      <eq:holomorphic-automorphism-group-on-unit-ball-statement>,
    )
    where $bold(U), bold(V)$ are unitary matrices, $a in DD$, and $bold(phi)_a$ is defined as in @eq:unit-ball-simple-automorphism_statement (and every such function lies in $Aut(B^n)$).
  ],
  <thm:holomorphic-automorphism-group-on-unit-ball>,
)
...
#proof[
  ...
  Now let $bold(phi)_(norm(bold(alpha)))$ be as in @prop:unit-ball-simple-automorphism, mapping $(norm(bold(alpha)), 0, dots, 0)$ to $bold(0)$. Then, the map $bold(phi)_(norm(bold(alpha))) compose bold(U) bold(f) in Aut(B^n)$ fixes $bold(0)$, so by @prop:unit-ball-automorphism-fixed-point-at-zero it is a unitary transformation, say $bold(V)$. Therefore,
  $
