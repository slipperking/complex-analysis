...
#show: docs-subchapter.with(
  ...
  route: "consequences-of-holomorphy",
)
...
#lbl(
  ...
  <thm:cauchy-integral-formula-on-polydisks>,
)
...
#proof[
  For each $j$, let $epsilon_j$ satisfy $D(z_j, epsilon_j) subset.eq D(a_j, r_j)$. By Cauchy's Integral Formula (@thm:cauchy-integral-formula-on-polydisks), we have
  $
...
#lbl(
  ...
  <thm:taylor-expansion-multivariable>,
)

#proof[
  By @thm:cauchy-integral-formula-on-polydisks we have
  $
  ...
  $
  By the Cauchy Integral Formula (@thm:cauchy-integral-formula-on-polydisks), we have
  $
