...
#proof[
  ...
  For a compact subset $I subset RR$, the complex rectangle $K = {x + ii y : 1 <= x <= 2, y in I}$ is compact in $CC$. Thus, by uniform continuity (given by @thm:heine-cantor), $forall epsilon > 0$, $exists delta > 0$ such that $forall s_1 = sigma_1 + ii t_1 in K, forall s_2 = sigma_2 + ii t_2 in K : abs(s_1 - s_2) < delta,$
