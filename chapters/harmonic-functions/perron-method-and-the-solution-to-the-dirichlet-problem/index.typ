...
#proof[
  ...
  #proof[
    ...
    + If $z in U without E_epsilon$, then $f(z) < M + epsilon$. By continuity, there exists a neighborhood $V in.rev z$ on which $f < M + epsilon$ holds.
    ...
    Hence, for any $epsilon > 0$, $E_epsilon = emptyset$; which implies that $forall z in U$, $psi(z) <= M$.
  ]
]
