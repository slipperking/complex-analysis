...
#proof[
  The first part is to prove that any holomorphic function on $U$ has continuous first-order partial derivatives in $U$. This requires an argument that will be covered later, specifically in @sec:analyticity-and-holomorphy, which states that the complex derivative of any holomorphic function is also holomorphic over the region.
...
We will prove later in @sec:analyticity-and-holomorphy that the complex derivative of a holomorphic function $f(z) = u(z) + ii v(z)$ is holomorphic. Under this assumption, $f(z)$ has continuous second-order partial derivatives, and therefore,
