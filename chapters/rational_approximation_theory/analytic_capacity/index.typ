...
#proof[
  ...
  We now show that $z mapsto overline(z)$ cannot be uniformly rationally approximated on $K$. By explicit calculation or Green's Theorem (@thm:complex_green), we have
  $
