...
#proof("Alternative Proof")[
  ...
  Since $z |-> (f(z)) / (z-a)$ is holomorphic on the disk centered at $b$ and $z |-> (f(z)) / (z-b)$ is holomorphic on the disk centered at $a$, by the Cauchy--Goursat Formula (@thm:cauchygoursatformula), we have
