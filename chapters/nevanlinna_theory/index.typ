...
The study of value distribution has gained considerable prominence recently. In 1798, Gauss presented a geometric proof of the Fundamental Theorem of Algebra (@thm:fundamental-theorem-of-algebra) under certain topological assumptions. Subsequently, in 1806, Argand provided the first rigorous proof. A direct consequence is that polynomials attain every complex value precisely as many times as their degree, accounting for multiplicities. General entire functions, however, exhibit different behavior; for instance, $exp$ omits the values $0$ and $oo$ while attaining all others infinitely often. We have already established Picard's theorem for entire functions.
...
The L. V. Ahlfors has also discovered a geometric theory that in general reflects the many concepts in Nevanlinna Theory in a geometric way (including the first and second fundamental theorems) via covering surfaces. This viewpoint will not be discussed here, although it is covered with sufficient detail in @hayman1964meromorphic.

#chapter-section("nevanlinna_functions")[
