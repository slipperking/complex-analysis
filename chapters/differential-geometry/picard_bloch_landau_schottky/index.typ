...
#thm-state.thm-restate("thm:casorati-weierstrass", final: true)
...
The efforts of many mathematicians resulted in several alternative proofs following that of Picard; the geometric realization of Ahlfors (@thm:schwarz-ahlfors-pick) was followed by results discovered by R. M. Robinson. Other approaches from Nevanlinna theory appeared later in the 20th century.
