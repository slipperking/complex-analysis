...
#lbl(
  ...
  <thm:casorati-weierstrassentire>,
)
...
In @sec:differential-geometry, we will prove a profound generalization of the two results (@thm:greatpicard and @thm:littlepicard), which was first proved by Emile Picard in 1879:
