...
#show: docs-subchapter.with(
  ...
  route: "properties-of-entire-meromorphic",
  children: [
...
#lbl(
  ...
  <thm:generalized-argument-principle>,
)
...
#proof[
  ...
  $
  since $psi$ is holomorphic there, $f$ is meromorphic with no other singularities, and $f != 0$ on $gamma$. The oriented boundary of this punctured domain is $gamma^+ union union.big_(i = 1)^k partial D(a_i, epsilon_i)^- union union.big_(j = 1)^m partial D(b_j, epsilon'_j)^-$. By Cauchy--Goursat (@thm:cauchy-goursat-theorem),
  $
  ...
  $
  where the first term has been reduced by the Cauchy--Goursat Formula (@thm:cauchy-goursat-formula) and the second integral vanishes by the Cauchy--Goursat Theorem (@thm:cauchy-goursat-theorem).
