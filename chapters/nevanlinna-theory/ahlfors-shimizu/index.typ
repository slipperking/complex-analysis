...
#show: docs-subchapter.with(
  title: [The Ahlfors--Shimizu Characteristic],
  route: "ahlfors-shimizu",
)
...
$
  ...
  &=#[[area of $f compose D(0,r)$ on $S^2$ with multiplicities]] / #[[area of $S^2$ (Riemann sphere)]]\
...
#remark[
  ...
  This normalization is present throughout Ahlfors' works; in @sec:differential-geometry, the spherical and hyperbolic metrics are also defined without a $2 dot$ factor (and hence yield curvatures of $plus.minus 4$). There is little fundamental difference between the two normalizations, and we have adopted the sphere of diameter $2$ to uniformize better with the previous sections.
]
