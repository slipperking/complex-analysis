...
#proof[of equivalent definitions][
  ...
  $
  which is a contradiction. The converse follows similarly to the case of entire functions in @sec:classifying_growth-of-entire-functions.
]

#theorem[
  Let $rho_M$ be the order of a non-constant entire function $f$ as defined in @sec:classifying_growth-of-entire-functions and let $rho_T$ be the order as defined in @def:order_of_meromorphic_function. Then $rho_M = rho_T$.
]
