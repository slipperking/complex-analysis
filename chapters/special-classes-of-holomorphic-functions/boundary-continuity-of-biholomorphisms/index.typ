...
#proof[
  ...
  Thus $F : N_1^+ -> HH^+$ is univalent, continuous up to $N_1 inter RR$, and real-valued there. The Schwarz Reflection Principle (@thm:schwarz-reflection-principle) extends $F$ biholomorphically to
  $
